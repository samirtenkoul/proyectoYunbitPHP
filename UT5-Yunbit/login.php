...
<body>
	...
	<h1>Login</h1>
	<label>Usuario: <input type="text" name="usuario" value="<?php echo $usuario; ?>"><br/></label>
	<label>Contraseña: <input type="password" name="clave" value="<?php echo $clave; ?>"></label>
        <br/>
        <span style="color:red;"><?php echo $errorUsu; ?>
	<?php echo $errorCont; ?>
        <?php echo $errorTodos;	?></span>	
	<br/>
